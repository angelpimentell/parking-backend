...
class TicketPlanController extends Controller
{
    ...
    {
        $modelRequestAdapter = new ModelRequestAdapter(TicketPlan::class, $request);

        $per_page = $modelRequestAdapter->get_pagination();
        $ticketPlans = $modelRequestAdapter->prepare_query();
